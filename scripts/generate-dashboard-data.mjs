...
function readSourceManifests() {
  return {
    ...
    investingAllocationTargets: readWorkspaceManifest(path.join('memory', 'investing', 'allocation-targets', 'latest.json')),
    investingDailyTradeAnalysis: readWorkspaceManifest(path.join('memory', 'investing', 'daily-trade-analysis', 'latest.json')),
    investingDailyMarketBrief: readWorkspaceManifest(path.join('memory', 'investing', 'daily-market-brief', 'latest.json')),
    ...
    investingConsolidationInbox: readWorkspaceManifest(path.join('memory', 'investing', 'consolidation-action-inbox', 'latest.json')),
...
function buildData() {
  ...
  return {
    meta: {
      ...
      investingAllocationTargets: sourceManifests.investingAllocationTargets || null,
      investingDailyTradeAnalysis: sourceManifests.investingDailyTradeAnalysis || null,
      investingDailyMarketBrief: sourceManifests.investingDailyMarketBrief || null,
      ...
      investingConsolidationInbox: sourceManifests.investingConsolidationInbox || null,
